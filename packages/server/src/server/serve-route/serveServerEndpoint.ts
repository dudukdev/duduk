...
export async function executeServer(req: IncomingMessage, res: Parameters<RequestListener>[1], stack: RoutePart[], params: Record<string, string>, locals: App.Locals): Promise<void> {
  ...
  await httpHandler({request: req, response: res, data: cumulatedData, params, locals});
}
